...
const FetchData = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("https://newsapi.org/v2/top-headlines?country=in&apiKey=ebaa75d12f6c4b65bb1c95775a10ccb1");
    ...
    <>
      <div className='style'>
        <div className='container'>
          <h3 className='text-dark fs-5'><u>TOP HEADLINES</u></h3>
            ...
            {isLoading ? (
              ...
              data.map((eachItem, index) => (
                <div key={index} className='col-md-6'>
                  <div className='container my-3 p-3' style={{ boxShadow: "2px 2px 10px #888888", borderRadius: "10px" }}>
                    <h6 className='my-2 text-drak'>{eachItem.title}</h6>
