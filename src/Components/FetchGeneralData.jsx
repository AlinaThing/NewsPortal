...
const FetchGeneralData = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("https://newsapi.org/v2/top-headlines?country=in&category=general&apiKey=ebaa75d12f6c4b65bb1c95775a10ccb1");
  ...
  return (
    <>
     {/* <hr style={{ margin: '5px auto', width: '100%', borderTop: '1px solid black',padding:'0px' }} /> */}
      <div className='style'>
