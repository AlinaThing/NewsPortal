...
const FetchTechnologyData = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=ebaa75d12f6c4b65bb1c95775a10ccb1");
            ...
            {isLoading ? (
              ...
              data.map((eachItem, index) => (
                <div key={index} className='col-md-6'>
                  <div className='container my-3 p-3' style={{ boxShadow: "2px 2px 10px silver", borderRadius: "10px", height: "450px" }}>
                    <h6 className='my-2 text-dark'>{eachItem.title}</h6>
                    <div className='d-flex justify-content-center align-items-center'></div>
                    <img className='img-fluid' src={eachItem.urlToImage} alt="Image not Found" style={{ width: "500px", height: "200px", objectFit: "cover" }} />
...
export default FetchTechnologyData;
