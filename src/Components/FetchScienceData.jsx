...
const FetchScienceData = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=ebaa75d12f6c4b65bb1c95775a10ccb1");
...
export default FetchScienceData;
